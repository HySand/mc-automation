...
- [x] Visit promotion links in reference-aligned 20-worker batches; continue failed proxies until pool exhaustion and draw only after conclusive server progress.
